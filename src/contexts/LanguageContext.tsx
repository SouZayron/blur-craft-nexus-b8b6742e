...
const translations: Translations = {
  ...
  // About Page
  aboutTitle: { 
    pt: "Sobre o ZGames", en: "About ZGames", es: "Acerca de ZGames", ar: "حول ZGames",
    de: "Über ZGames", nl: "Over ZGames", tl: "Tungkol sa ZGames", tr: "ZGames Hakkında", bs: "O ZGames-u", fr: "À propos de ZGames", it: "Chi è ZGames", hu: "A ZGames-ról", pl: "O ZGames", "pt-pt": "Sobre o ZGames", ro: "Despre ZGames", sr: "O ZGames-u", th: "เกี่ยวกับ ZGames"
  },
  aboutIntro: { 
    pt: "O ZGames é um portal independente criado para reunir notícias, novidades, utilidades e ferramentas voltadas à comunidade do xat.com.", 
    en: "ZGames is an independent portal created to gather news, updates, utilities and tools aimed at the xat.com community.", 
    es: "ZGames es un portal independiente creado para reunir noticias, novedades, utilidades y herramientas dirigidas a la comunidad de xat.com.", 
    ar: "ZGames هو بوابة مستقلة تم إنشاؤها لجمع الأخبار والتحديثات والأدوات المساعدة الموجهة لمجتمع xat.com.",
    de: "ZGames ist ein unabhängiges Portal, das erstellt wurde, um Nachrichten, Updates, Dienstprogramme und Tools für die xat.com-Community zu sammeln.", 
    nl: "ZGames is een onafhankelijk portaal gemaakt om nieuws, updates, hulpprogramma's en tools voor de xat.com-community te verzamelen.", 
    tl: "Ang ZGames ay isang independenteng portal na nilikha upang magtipon ng balita, updates, utilities at tools para sa xat.com community.", 
    tr: "ZGames, xat.com topluluğu için haberler, güncellemeler, yardımcı programlar ve araçlar toplamak için oluşturulmuş bağımsız bir portaldır.", 
    bs: "ZGames je nezavisni portal kreiran za prikupljanje vijesti, novosti, alata i usluga namijenjenih xat.com zajednici.", 
    fr: "ZGames est un portail indépendant créé pour rassembler des nouvelles, des mises à jour, des utilitaires et des outils destinés à la communauté xat.com.", 
    it: "ZGames è un portale indipendente creato per raccogliere notizie, aggiornamenti, utility e strumenti per la community di xat.com.", 
    hu: "A ZGames egy független portál, amelyet a xat.com közösség híreinek, frissítéseinek, segédprogramjainak és eszközeinek összegyűjtésére hoztak létre.", 
    pl: "ZGames to niezależny portal stworzony w celu gromadzenia wiadomości, aktualizacji, narzędzi i usług dla społeczności xat.com.", 
    "pt-pt": "O ZGames é um portal independente criado para reunir notícias, novidades, utilidades e ferramentas voltadas à comunidade do xat.com.", 
    ro: "ZGames este un portal independent creat pentru a aduna știri, actualizări, utilități și instrumente pentru comunitatea xat.com.", 
    sr: "ZGames je nezavisni portal kreiran za prikupljanje vesti, novosti, alata i usluga namenjenih xat.com zajednici.", 
    th: "ZGames เป็นพอร์ทัลอิสระที่สร้างขึ้นเพื่อรวบรวมข่าวสาร อัปเดต ยูทิลิตี้ และเครื่องมือสำหรับชุมชน xat.com"
  },
  aboutObjective: { 
  ...
  aboutMission: { 
    pt: "O ZGames nasce como um espaço de experimentação e apoio à comunidade, trazendo soluções simples, rápidas e acessíveis, sempre com foco em usabilidade, criatividade e praticidade.", 
    en: "ZGames was born as a space for experimentation and community support, bringing simple, fast and accessible solutions, always focused on usability, creativity and practicality.", 
    es: "ZGames nace como un espacio de experimentación y apoyo a la comunidad, trayendo soluciones simples, rápidas y accesibles, siempre con enfoque en usabilidad, creatividad y practicidad.", 
    ar: "ولد ZGames كمساحة للتجريب ودعم المجتمع، مما يوفر حلولاً بسيطة وسريعة وسهلة الوصول، مع التركيز دائمًا على سهولة الاستخدام والإبداع والتطبيق العملي.",
    de: "ZGames wurde als Raum für Experimente und Community-Unterstützung geboren, der einfache, schnelle und zugängliche Lösungen bietet, immer mit Fokus auf Benutzerfreundlichkeit, Kreativität und Praktikabilität.", 
    nl: "ZGames is geboren als een ruimte voor experimentatie en community-ondersteuning, met eenvoudige, snelle en toegankelijke oplossingen, altijd gericht op bruikbaarheid, creativiteit en praktisch nut.", 
    tl: "Ang ZGames ay ipinanganak bilang isang espasyo para sa eksperimento at suporta sa komunidad, na nagdadala ng simple, mabilis at accessible na solusyon, palaging nakatuon sa usability, creativity at practicality.", 
    tr: "ZGames, kullanılabilirlik, yaratıcılık ve pratikliğe her zaman odaklanarak basit, hızlı ve erişilebilir çözümler sunan bir deneme ve topluluk destek alanı olarak doğdu.", 
    bs: "ZGames je nastao kao prostor za eksperimentiranje i podršku zajednici, donoseći jednostavna, brza i pristupačna rješenja, uvijek s fokusom na upotrebljivost, kreativnost i praktičnost.", 
    fr: "ZGames est né comme un espace d'expérimentation et de soutien communautaire, apportant des solutions simples, rapides et accessibles, toujours axées sur la convivialité, la créativité et la praticité.", 
    it: "ZGames è nato come uno spazio di sperimentazione e supporto alla community, portando soluzioni semplici, veloci e accessibili, sempre focalizzate su usabilità, creatività e praticità.", 
    hu: "A ZGames kísérletezési és közösségi támogatási térként született, egyszerű, gyors és hozzáférhető megoldásokat kínálva, mindig a használhatóságra, kreativitásra és praktikusságra összpontosítva.", 
    pl: "ZGames powstał jako przestrzeń do eksperymentów i wsparcia społeczności, oferując proste, szybkie i dostępne rozwiązania, zawsze skupione na użyteczności, kreatywności i praktyczności.", 
    "pt-pt": "O ZGames nasce como um espaço de experimentação e apoio à comunidade, trazendo soluções simples, rápidas e acessíveis, sempre com foco em usabilidade, criatividade e praticidade.", 
    ro: "ZGames s-a născut ca un spațiu de experimentare și suport pentru comunitate, aducând soluții simple, rapide și accesibile, mereu concentrate pe utilizare, creativitate și practică.", 
    sr: "ZGames je nastao kao prostor za eksperimentisanje i podršku zajednici, donoseći jednostavna, brza i pristupačna rešenja, uvijek s fokusom na upotrebljivost, kreativnost i praktičnost.", 
    th: "ZGames เกิดขึ้นเพื่อเป็นพื้นที่สำหรับการทดลองและการสนับสนุนชุมชน นำเสนอโซลูชันที่เรียบง่าย รวดเร็ว และเข้าถึงได้ โดยเน้นที่ความสามารถในการใช้งาน ความคิดสร้างสรรค์ และความเป็นจริง"
  },
  aboutDisclaimer: { 
  ...
  privacyIntro: { 
    pt: "A sua privacidade é importante para nós. No ZGames, respeitamos a privacidade dos usuários e estamos comprometidos em proteger as informações coletadas durante a navegação.", 
    en: "Your privacy is important to us. At ZGames, we respect user privacy and are committed to protecting the information collected during browsing.", 
    es: "Tu privacidad es importante para nosotros. En ZGames, respetamos la privacidad de los usuarios y estamos comprometidos a proteger la información recopilada durante la navegación.", 
    ar: "خصوصيتك مهمة بالنسبة لنا. في ZGames، نحترم خصوصية المستخدمين ونلتزم بحماية المعلومات التي يتم جمعها أثناء التصفح.",
    de: "Ihre Privatsphäre ist uns wichtig. Bei ZGames respektieren wir die Privatsphäre der Benutzer und verpflichten uns, die während des Surfens gesammelten Informationen zu schützen.", 
    nl: "Uw privacy is belangrijk voor ons. Bij ZGames respecteren we de privacy van gebruikers en zijn we toegewijd aan het beschermen van de informatie die tijdens het browsen wordt verzameld.", 
    tl: "Mahalaga sa amin ang iyong privacy. Sa ZGames, nirerespeto namin ang privacy ng mga user at nangangako kaming protektahan ang impormasyong nakolekta habang nagba-browse.", 
    tr: "Gizliliğiniz bizim için önemlidir. ZGames'ta kullanıcı gizliliğine saygı duyuyor ve gezinme sırasında toplanan bilgileri korumaya kararlıyız.", 
    bs: "Vaša privatnost nam je važna. U ZGames-u poštujemo privatnost korisnika i posvećeni smo zaštiti informacija prikupljenih tijekom pregledavanja.", 
    fr: "Votre vie privée nous est importante. Chez ZGames, nous respectons la vie privée des utilisateurs et nous nous engageons à protéger les informations collectées lors de la navigation.", 
    it: "La tua privacy è importante per noi. In ZGames, rispettiamo la privacy degli utenti e ci impegniamo a proteggere le informazioni raccolte durante la navigazione.", 
    hu: "Az Ön adatvédelme fontos számunkra. A ZGames-nál tiszteletben tartjuk a felhasználók adatvédelmét, és elkötelezettek vagyunk a böngészés során gyűjtött információk védelme mellett.", 
    pl: "Twoja prywatność jest dla nas ważna. W ZGames szanujemy prywatność użytkowników i zobowiązujemy się do ochrony informacji zebranych podczas przeglądania.", 
    "pt-pt": "A sua privacidade é importante para nós. No ZGames, respeitamos a privacidade dos utilizadores e estamos comprometidos em proteger as informações recolhidas durante a navegação.", 
    ro: "Confidențialitatea dvs. este importantă pentru noi. La ZGames, respectăm confidențialitatea utilizatorilor și ne angajăm să protejăm informațiile colectate în timpul navigării.", 
    sr: "Vaša privatnost nam je važna. U ZGames-u poštujemo privatnost korisnika i posvećeni smo zaštiti informacija prikupljenih tokom pregledanja.", 
    th: "ความเป็นส่วนตัวของคุณสำคัญสำหรับเรา ที่ ZGames เราเคารพความเป็นส่วนตัวของผู้ใช้และมุ่งมั่นที่จะปกป้องข้อมูลที่รวบรวมระหว่างการเรียกดู"
  },
  ...
  privacySharingContent: { 
    pt: "O ZGames não vende, troca ou compartilha informações pessoais dos usuários com terceiros, exceto quando exigido por lei.", 
    en: "ZGames does not sell, trade or share users' personal information with third parties, except when required by law.", 
    es: "ZGames no vende, intercambia ni comparte información personal de los usuarios con terceros, excepto cuando lo exija la ley.", 
    ar: "لا يقوم ZGames ببيع أو تبادل أو مشاركة المعلومات الشخصية للمستخدمين مع أطراف ثالثة، إلا عندما يقتضي القانون ذلك.",
    de: "ZGames verkauft, handelt oder teilt keine persönlichen Informationen der Benutzer mit Dritten, außer wenn dies gesetzlich vorgeschrieben ist.", 
    nl: "ZGames verkoopt, ruilt of deelt geen persoonlijke informatie van gebruikers met derden, behalve wanneer dit wettelijk vereist is.", 
    tl: "Hindi ibinebenta, ipinagpapalit o ibinabahagi ng ZGames ang personal na impormasyon ng mga user sa third parties, maliban kung kinakailangan ng batas.", 
    tr: "ZGames, kullanıcıların kişisel bilgilerini yasal olarak gerekli olmadıkça üçüncü taraflarla satmaz, takas etmez veya paylaşmaz.", 
    bs: "ZGames ne prodaje, ne trguje niti dijeli osobne podatke korisnika s trećim stranama, osim kada to zahtijeva zakon.", 
    fr: "ZGames ne vend, n'échange ni ne partage les informations personnelles des utilisateurs avec des tiers, sauf lorsque la loi l'exige.", 
    it: "ZGames non vende, scambia o condivide le informazioni personali degli utenti con terze parti, salvo quando richiesto dalla legge.", 
    hu: "A ZGames nem adja el, nem cseréli és nem osztja meg a felhasználók személyes adatait harmadik felekkel, kivéve, ha a törvény előírja.", 
    pl: "ZGames nie sprzedaje, nie wymienia ani nie udostępnia danych osobowych użytkowników stronom trzecim, chyba że wymaga tego prawo.", 
    "pt-pt": "O ZGames não vende, troca ou partilha informações pessoais dos utilizadores com terceiros, exceto quando exigido por lei.", 
    ro: "ZGames nu vinde, nu schimbă și nu partajează informațiile personale ale utilizatorilor cu terți, cu excepția cazului în care legea o impune.", 
    sr: "ZGames ne prodaje, ne trguje niti deli lične podatke korisnika sa trećim stranama, osim kada to zahteva zakon.", 
    th: "ZGames ไม่ขาย แลกเปลี่ยน หรือแบ่งปันข้อมูลส่วนบุคคลของผู้ใช้กับบุคคลที่สาม ยกเว้นเมื่อกฎหมายกำหนด"
  },
  privacyLinksTitle: { 
  ...
  privacyConsentContent: { 
    pt: "Ao utilizar o ZGames, você concorda com esta Política de Privacidade.", 
    en: "By using ZGames, you agree to this Privacy Policy.", 
    es: "Al usar ZGames, aceptas esta Política de Privacidad.", 
    ar: "باستخدام ZGames، فإنك توافق على سياسة الخصوصية هذه.",
    de: "Durch die Nutzung von ZGames stimmen Sie dieser Datenschutzrichtlinie zu.", 
    nl: "Door ZGames te gebruiken, gaat u akkoord met dit Privacybeleid.", 
    tl: "Sa paggamit ng ZGames, sumasang-ayon ka sa Privacy Policy na ito.", 
    tr: "ZGames'ı kullanarak bu Gizlilik Politikasını kabul etmiş olursunuz.", 
    bs: "Korištenjem ZGames-a pristajete na ovu Politiku privatnosti.", 
    fr: "En utilisant ZGames, vous acceptez cette Politique de Confidentialité.", 
    it: "Utilizzando ZGames, accetti questa Informativa sulla Privacy.", 
    hu: "A ZGames használatával elfogadja ezt az Adatvédelmi irányelvet.", 
    pl: "Korzystając z ZGames, zgadzasz się z niniejszą Polityką prywatności.", 
    "pt-pt": "Ao utilizar o ZGames, concorda com esta Política de Privacidade.", 
    ro: "Prin utilizarea ZGames, sunteți de acord cu această Politică de Confidențialitate.", 
    sr: "Korišćenjem ZGames-a pristajete na ovu Politiku privatnosti.", 
    th: "การใช้ ZGames แสดงว่าคุณยอมรับนโยบายความเป็นส่วนตัวนี้"
  },
  ...
  termsIntro: {
    pt: "Bem-vindo ao ZGames. Ao acessar e usar este site, você concorda com os seguintes termos e condições.",
    en: "Welcome to ZGames. By accessing and using this website, you agree to the following terms and conditions.",
    es: "Bienvenido a ZGames. Al acceder y usar este sitio web, usted acepta los siguientes términos y condiciones.",
    ar: "مرحبًا بك في ZGames. من خلال الوصول إلى هذا الموقع واستخدامه، فإنك توافق على الشروط والأحكام التالية.",
    de: "Willkommen bei ZGames. Durch den Zugriff auf und die Nutzung dieser Website stimmen Sie den folgenden Geschäftsbedingungen zu.",
    nl: "Welkom bij ZGames. Door deze website te bezoeken en te gebruiken, gaat u akkoord met de volgende voorwaarden.",
    tl: "Maligayang pagdating sa ZGames. Sa pag-access at paggamit ng website na ito, sumasang-ayon ka sa mga sumusunod na tuntunin at kundisyon.",
    tr: "ZGames'a hoş geldiniz. Bu web sitesine erişerek ve kullanarak aşağıdaki şartları ve koşulları kabul etmiş olursunuz.",
    bs: "Dobrodošli na ZGames. Pristupom i korištenjem ove web stranice prihvaćate sljedeće uvjete i odredbe.",
    fr: "Bienvenue sur ZGames. En accédant et en utilisant ce site Web, vous acceptez les termes et conditions suivants.",
    it: "Benvenuto su ZGames. Accedendo e utilizzando questo sito web, accetti i seguenti termini e condizioni.",
    hu: "Üdvözöljük a ZGames-on. A weboldal elérésével és használatával elfogadja az alábbi feltételeket.",
    pl: "Witamy w ZGames. Uzyskując dostęp i korzystając z tej strony internetowej, zgadzasz się na następujące warunki.",
    "pt-pt": "Bem-vindo ao ZGames. Ao aceder e utilizar este site, concorda com os seguintes termos e condições.",
    ro: "Bun venit la ZGames. Accesând și utilizând acest site web, sunteți de acord cu următorii termeni și condiții.",
    sr: "Dobrodošli na ZGames. Pristupom i korišćenjem ove veb stranice prihvatate sledeće uslove i odredbe.",
    th: "ยินดีต้อนรับสู่ ZGames เมื่อเข้าถึงและใช้เว็บไซต์นี้ คุณยอมรับข้อกำหนดและเงื่อนไขต่อไปนี้"
  },
  termsUseTitle: {
  ...
  termsIntellectualContent: {
    pt: "Todo o conteúdo do ZGames, incluindo textos, gráficos, logos, ícones e software, é propriedade do ZGames ou de seus criadores de conteúdo e está protegido por leis de direitos autorais. É proibida a reprodução não autorizada.",
    en: "All ZGames content, including texts, graphics, logos, icons and software, is the property of ZGames or its content creators and is protected by copyright laws. Unauthorized reproduction is prohibited.",
    es: "Todo el contenido de ZGames, incluidos textos, gráficos, logotipos, iconos y software, es propiedad de ZGames o de sus creadores de contenido y está protegido por las leyes de derechos de autor. Se prohíbe la reproducción no autorizada.",
    ar: "جميع محتويات ZGames، بما في ذلك النصوص والرسومات والشعارات والأيقونات والبرامج، هي ملك ZGames أو منشئي المحتوى التابعين له ومحمية بموجب قوانين حقوق النشر. النسخ غير المصرح به محظور.",
    de: "Alle ZGames-Inhalte, einschließlich Texte, Grafiken, Logos, Icons und Software, sind Eigentum von ZGames oder seinen Inhaltserstellern und durch Urheberrechtsgesetze geschützt.",
    nl: "Alle ZGames-inhoud, inclusief teksten, afbeeldingen, logo's, pictogrammen en software, is eigendom van ZGames of zijn contentmakers en wordt beschermd door auteursrechtwetten.",
    tl: "Lahat ng nilalaman ng ZGames, kabilang ang mga teksto, graphics, logos, icons at software, ay pag-aari ng ZGames o ng mga tagalikha ng nilalaman nito at protektado ng mga batas sa copyright.",
    tr: "Metinler, grafikler, logolar, simgeler ve yazılımlar dahil tüm ZGames içeriği, ZGames'a veya içerik oluşturucularına aittir ve telif hakkı yasalarıyla korunmaktadır.",
    bs: "Sav sadržaj ZGames-a, uključujući tekstove, grafike, logotipe, ikone i softver, vlasništvo je ZGames-a ili njegovih kreatora sadržaja i zaštićen je zakonima o autorskim pravima.",
    fr: "Tout le contenu de ZGames, y compris les textes, graphiques, logos, icônes et logiciels, est la propriété de ZGames ou de ses créateurs de contenu et est protégé par les lois sur le droit d'auteur.",
    it: "Tutti i contenuti di ZGames, inclusi testi, grafica, loghi, icone e software, sono di proprietà di ZGames o dei suoi creatori di contenuti e sono protetti dalle leggi sul copyright.",
    hu: "A ZGames minden tartalma, beleértve a szövegeket, grafikákat, logókat, ikonokat és szoftvereket, a ZGames vagy tartalomkészítőinek tulajdona, és szerzői jogi törvények védik.",
    pl: "Cała zawartość ZGames, w tym teksty, grafiki, logo, ikony i oprogramowanie, jest własnością ZGames lub twórców treści i jest chroniona prawem autorskim.",
    "pt-pt": "Todo o conteúdo do ZGames, incluindo textos, gráficos, logos, ícones e software, é propriedade do ZGames ou dos seus criadores de conteúdo e está protegido por leis de direitos de autor.",
    ro: "Tot conținutul ZGames, inclusiv texte, grafică, logo-uri, pictograme și software, este proprietatea ZGames sau a creatorilor săi de conținut și este protejat de legile privind drepturile de autor.",
    sr: "Sav sadržaj ZGames-a, uključujući tekstove, grafike, logotipe, ikone i softver, vlasništvo je ZGames-a ili njegovih kreatora sadržaja i zaštićen je zakonima o autorskim pravima.",
    th: "เนื้อหาทั้งหมดของ ZGames รวมถึงข้อความ กราฟิก โลโก้ ไอคอน และซอฟต์แวร์ เป็นทรัพย์สินของ ZGames หรือผู้สร้างเนื้อหาและได้รับการคุ้มครองโดยกฎหมายลิขสิทธิ์"
  },
  termsLiabilityTitle: {
  ...
  termsLiabilityContent: {
    pt: "O ZGames não se responsabiliza por quaisquer danos diretos, indiretos, incidentais ou consequentes resultantes do uso ou incapacidade de usar este site. Usamos ferramentas de terceiros e não garantimos disponibilidade contínua.",
    en: "ZGames is not liable for any direct, indirect, incidental or consequential damages resulting from the use or inability to use this website. We use third-party tools and do not guarantee continuous availability.",
    es: "ZGames no es responsable de ningún daño directo, indirecto, incidental o consecuente resultante del uso o la incapacidad de usar este sitio web. Usamos herramientas de terceros y no garantizamos disponibilidad continua.",
    ar: "ZGames غير مسؤول عن أي أضرار مباشرة أو غير مباشرة أو عرضية أو تبعية ناتجة عن استخدام هذا الموقع أو عدم القدرة على استخدامه. نستخدم أدوات طرف ثالث ولا نضمن التوفر المستمر.",
    de: "ZGames haftet nicht für direkte, indirekte, zufällige oder Folgeschäden, die aus der Nutzung oder der Unfähigkeit zur Nutzung dieser Website entstehen.",
    nl: "ZGames is niet aansprakelijk voor directe, indirecte, incidentele of gevolgschade als gevolg van het gebruik of het onvermogen om deze website te gebruiken.",
    tl: "Ang ZGames ay hindi mananagot para sa anumang direkta, hindi direkta, insidental o consequential na pinsala na nagmumula sa paggamit o kawalan ng kakayahang gamitin ang website na ito.",
    tr: "ZGames, bu web sitesinin kullanımından veya kullanılamamasından kaynaklanan doğrudan, dolaylı, arızi veya sonuç olarak ortaya çıkan zararlardan sorumlu değildir.",
    bs: "ZGames nije odgovoran za bilo kakve direktne, indirektne, slučajne ili posljedične štete koje proizlaze iz korištenja ili nemogućnosti korištenja ove web stranice.",
    fr: "ZGames n'est pas responsable des dommages directs, indirects, accessoires ou consécutifs résultant de l'utilisation ou de l'impossibilité d'utiliser ce site Web.",
    it: "ZGames non è responsabile per eventuali danni diretti, indiretti, incidentali o consequenziali derivanti dall'uso o dall'impossibilità di utilizzare questo sito web.",
    hu: "A ZGames nem vállal felelősséget a weboldal használatából vagy használhatatlanságából eredő közvetlen, közvetett, véletlen vagy következményes károkért.",
    pl: "ZGames nie ponosi odpowiedzialności za jakiekolwiek bezpośrednie, pośrednie, przypadkowe lub wynikowe szkody wynikające z korzystania lub niemożności korzystania z tej strony internetowej.",
    "pt-pt": "O ZGames não se responsabiliza por quaisquer danos diretos, indiretos, incidentais ou consequentes resultantes do uso ou incapacidade de usar este site.",
    ro: "ZGames nu este răspunzător pentru daune directe, indirecte, incidentale sau consecutive care rezultă din utilizarea sau incapacitatea de a utiliza acest site web.",
    sr: "ZGames nije odgovoran za bilo kakve direktne, indirektne, slučajne ili posledične štete koje proizlaze iz korišćenja ili nemogućnosti korišćenja ove veb stranice.",
    th: "ZGames ไม่รับผิดชอบต่อความเสียหายโดยตรง โดยอ้อม โดยบังเอิญ หรือเป็นผลสืบเนื่องจากการใช้หรือไม่สามารถใช้เว็บไซต์นี้ได้"
  },
  termsAcceptTitle: {
  ...
  termsAcceptContent: {
    pt: "Ao continuar a usar o ZGames, você confirma que leu, entendeu e concorda com estes Termos de Serviço. Reservamo-nos o direito de modificar estes termos a qualquer momento.",
    en: "By continuing to use ZGames, you confirm that you have read, understood and agree to these Terms of Service. We reserve the right to modify these terms at any time.",
    es: "Al continuar usando ZGames, confirma que ha leído, entendido y acepta estos Términos de Servicio. Nos reservamos el derecho de modificar estos términos en cualquier momento.",
    ar: "من خلال الاستمرار في استخدام ZGames، فإنك تؤكد أنك قد قرأت وفهمت ووافقت على شروط الخدمة هذه. نحتفظ بالحق في تعديل هذه الشروط في أي وقت.",
    de: "Durch die weitere Nutzung von ZGames bestätigen Sie, dass Sie diese Nutzungsbedingungen gelesen, verstanden und akzeptiert haben. Wir behalten uns das Recht vor, diese Bedingungen jederzeit zu ändern.",
    nl: "Door ZGames te blijven gebruiken, bevestigt u dat u deze Servicevoorwaarden hebt gelezen, begrepen en ermee akkoord gaat. We behouden ons het recht voor om deze voorwaarden op elk moment te wijzigen.",
    tl: "Sa patuloy na paggamit ng ZGames, kinukumpirma mo na nabasa, naunawaan at sumasang-ayon ka sa mga Tuntunin ng Serbisyong ito. Inilalaan namin ang karapatan na baguhin ang mga tuntuning ito anumang oras.",
    tr: "ZGames'ı kullanmaya devam ederek bu Hizmet Şartlarını okuduğunuzu, anladığınızı ve kabul ettiğinizi onaylarsınız. Bu şartları herhangi bir zamanda değiştirme hakkını saklı tutarız.",
    bs: "Nastavkom korištenja ZGames-a potvrđujete da ste pročitali, razumjeli i prihvatili ove Uvjete korištenja. Zadržavamo pravo izmjene ovih uvjeta u bilo kojem trenutku.",
    fr: "En continuant à utiliser ZGames, vous confirmez avoir lu, compris et accepté ces Conditions d'utilisation. Nous nous réservons le droit de modifier ces conditions à tout moment.",
    it: "Continuando a utilizzare ZGames, confermi di aver letto, compreso e accettato questi Termini di Servizio. Ci riserviamo il diritto di modificare questi termini in qualsiasi momento.",
    hu: "A ZGames további használatával megerősíti, hogy elolvasta, megértette és elfogadja ezeket a Szolgáltatási feltételeket. Fenntartjuk a jogot, hogy bármikor módosítsuk ezeket a feltételeket.",
    pl: "Kontynuując korzystanie z ZGames, potwierdzasz, że przeczytałeś, zrozumiałeś i zgadzasz się z niniejszymi Warunkami usługi. Zastrzegamy sobie prawo do zmiany tych warunków w dowolnym momencie.",
    "pt-pt": "Ao continuar a usar o ZGames, confirma que leu, compreendeu e concorda com estes Termos de Serviço. Reservamo-nos o direito de modificar estes termos a qualquer momento.",
    ro: "Continuând să utilizați ZGames, confirmați că ați citit, înțeles și sunteți de acord cu acești Termeni de Serviciu. Ne rezervăm dreptul de a modifica acești termeni în orice moment.",
    sr: "Nastavljanjem korišćenja ZGames-a potvrđujete da ste pročitali, razumeli i prihvatili ove Uslove korišćenja. Zadržavamo pravo izmene ovih uslova u bilo kom trenutku.",
    th: "เมื่อใช้ ZGames ต่อไป คุณยืนยันว่าคุณได้อ่าน เข้าใจ และยอมรับข้อกำหนดในการให้บริการเหล่านี้ เราขอสงวนสิทธิ์ในการแก้ไขข้อกำหนดเหล่านี้ได้ตลอดเวลา"
  },
  termsOfService: {
  ...
  // Blog
  blogTitle: { pt: "Blog ZGames", en: "ZGames Blog" },
  blogSubtitle: {
