...
GRANT EXECUTE ON FUNCTION public.altavibe_spin(text) TO anon, authenticated;

CREATE OR REPLACE FUNCTION public.altavibe_login(p_name text)
...
GRANT EXECUTE ON FUNCTION public.altavibe_login(text) TO anon, authenticated;
