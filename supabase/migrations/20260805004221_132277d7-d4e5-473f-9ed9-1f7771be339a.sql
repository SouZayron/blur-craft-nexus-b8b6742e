...
ALTER TABLE public.altavibe_users ADD COLUMN IF NOT EXISTS spins_today integer NOT NULL DEFAULT 0;
ALTER TABLE public.altavibe_settings ADD COLUMN IF NOT EXISTS max_spins_per_day integer NOT NULL DEFAULT 3;
ALTER TABLE public.altavibe_settings ADD COLUMN IF NOT EXISTS signup_deadline date NOT NULL DEFAULT '2026-08-06';
...
BEGIN
  ...
  IF NOT FOUND THEN
    IF COALESCE(s.signups_locked, false) OR today >= COALESCE(s.signup_deadline, '2026-08-06'::date) THEN
